...
export function AppShell({
  ...
  return (
    <div className="flex min-h-screen bg-background bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#fff8f6] via-[#faf5f3] to-[#fbf8f7] font-sans">
      <aside className="relative z-10 flex w-[280px] shrink-0 flex-col justify-between border-r border-border/40 bg-white/40 p-6 backdrop-blur-2xl transition-all duration-300">
        <div>
      ...
      <main className="relative z-10 min-w-0 flex-1 bg-white/70 p-8 md:p-14 backdrop-blur-xl overflow-y-auto shadow-[-20px_0_50px_rgba(4,16,49,0.02)]">
